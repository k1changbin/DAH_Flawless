...
TACTIC_CATALOG: tuple[TacticSpec, ...] = (
    ...
    TacticSpec(
        ...
        goal="make battery drift look operationally plausible by shaping adjacent rate fields",
    ...
    TacticSpec(
        ...
        goal="widen the external telemetry gap where internal cross-checks are degraded",
