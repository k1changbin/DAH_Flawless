...
from dah_flawless.config import DEFAULT_ROUNDS, DEFAULT_SEED
...
def main() -> None:
    args = parse_args()
    logs, summary = run_simulation(seed=args.seed, rounds=args.rounds, log_path=args.out, summary_path=args.summary)
